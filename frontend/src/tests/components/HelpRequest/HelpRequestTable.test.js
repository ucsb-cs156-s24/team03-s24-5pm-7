...
describe("UserTable tests", () => {
  ...
  test("Has the expected column headers and content for ordinary user", () => {
    ...
    expect(screen.getByTestId(`${testId}-cell-row-0-col-solved`)).toBeTruthy();
    ...
    expect(screen.getByTestId(`${testId}-cell-row-1-col-solved`)).toBeTruthy();
    ...
    expect(screen.getByTestId(`${testId}-cell-row-1-col-explanation`)).toHaveTextContent("Dokku deployment issues.");
    expect(screen.getByTestId(`${testId}-cell-row-1-col-solved`).textContent).toBeFalsy();
