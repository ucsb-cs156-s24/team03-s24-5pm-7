...
describe("UCSBOrganizationTable tests", () => {
  ...
  test("Has the expected column headers and content for ordinary user", () => {
    ...
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <UCSBOrganizationTable organizations={ucsbOrganizationFixtures.threeOrgs} currentUser={currentUser} />
        </MemoryRouter>
      </QueryClientProvider>
    ...
    expect(screen.getByTestId(`${testId}-cell-row-1-col-orgCode`)).toHaveTextContent("CSU");
  ...
  test("Has the expected column headers and content for an adminUser", () => {
  ...
  test("Edit button navigates to the edit page for admin user", async () => {
    ...
    await waitFor(() => { expect(screen.getByTestId(`UCSBOrganizationTable-cell-row-0-col-orgCode`)).toHaveTextContent("DSP"); });
    ...
    await waitFor(() => expect(mockedNavigate).toHaveBeenCalledWith('/ucsborganizations/edit/DSP'));
  ...
  test("Delete button calls delete callback", async () => {
    ...
    expect(await screen.findByTestId(`${testId}-cell-row-0-col-orgCode`)).toHaveTextContent("DSP");
