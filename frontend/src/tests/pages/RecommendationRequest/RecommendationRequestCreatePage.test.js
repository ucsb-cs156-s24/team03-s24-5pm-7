...
describe("RecommendationRequestCreatePage tests", () => {
    ...
    test("when you fill in the form and hit submit, it makes a request to the backend", async () => {
        ...
        const recommendationRequest = {
            ...
            explanation: "please",
            dateRequested: "2024-05-12T00:00",
            dateNeeded: "2024-05-13T00:00",
            done: true
        };

        axiosMock.onPost("/api/ucsbrecommendationrequest/post").reply(202, recommendationRequest);
        ...
        fireEvent.change(requesterEmail, { target: { value: 'adil@ucsb.edu' } });
        fireEvent.change(professorEmail, { target: { value: 'pconrad@ucsb.edu' } });
        fireEvent.change(explanation, { target: { value: 'please' } });
        fireEvent.change(dateRequested, { target: { value: '2024-05-12T00:00' } });
        fireEvent.change(dateNeeded, { target: { value: '2024-05-13T00:00' } });
