...
describe("UCSBOrganizationEditPage tests", () => {
    ...
    describe("when the backend doesn't return data", () => {
        ...
        beforeEach(() => {
            ...
            axiosMock.onGet("/api/ucsborganizations", { params: { orgCode: "DSP" } }).timeout();
        });
    ...
    describe("tests where backend is working normally", () => {
        ...
        beforeEach(() => {
            ...
            axiosMock.onGet("/api/currentUser").reply(200, apiCurrentUserFixtures.userOnly);
            axiosMock.onGet("/api/systemInfo").reply(200, systemInfoFixtures.showingNeither);
            axiosMock.onGet("/api/ucsborganizations", { params: { orgCode: "DSP" } }).reply(200, {
                orgCode: "DSP",
            ...
            axiosMock.onPut('/api/ucsborganizations').reply(200, {
                orgCode: "DSP",
                orgTranslationShort: "Delt",
                orgTranslation: "Deltasig",
                inactive: true
            });
        ...
        test("Is populated with the data provided", async () => {
           ...
           await screen.findByTestId("UCSBOrganizationForm-orgCode");
            ...
            expect(orgCodeField).toHaveValue("DSP");
            ...
            fireEvent.change(orgTranslationShortField, { target: { value: 'Delt' } });
            fireEvent.change(orgTranslationField, { target: { value: 'Deltasig' } });
