...
public class UCSBOrganizationIT {
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                // act
                MvcResult response = mockMvc.perform(get("/api/ucsborganizations?orgCode=DSP"))
        ...
        public void an_admin_user_can_post_a_new_restaurant() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/ucsborganizations/post?orgCode=ZPR&orgTranslationShort=zeta&orgTranslation=zetaphirho&inactive=false")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
