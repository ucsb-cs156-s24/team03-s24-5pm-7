...
public class ArticleWebIT extends WebTestCase{
    ...
    public void admin_user_can_create_edit_delete_restaurant() throws Exception {
        ...
        page.getByTestId("ArticlesForm-title").fill("Seventeen");
        page.getByTestId("ArticlesForm-url").fill("https://seventeenIsHere.com");
        page.getByTestId("ArticlesForm-explanation").fill("Carat support you for more than 3000 years");
        page.getByTestId("ArticlesForm-email").fill("Carat@17.com");
        page.getByTestId("ArticlesForm-dateAdded").fill("2015-07-17T08:08");
        page.getByTestId("ArticlesForm-submit").click();

        assertThat(page.getByTestId("ArticlesTable-cell-row-0-col-explanation"))
                .hasText("Carat support you for more than 3000 years");
