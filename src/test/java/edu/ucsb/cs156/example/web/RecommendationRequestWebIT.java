...
public class RecommendationRequestWebIT extends WebTestCase{
    ...
    public void admin_user_can_create_edit_delete_recommendationrequest() throws Exception {
        ...
        page.getByTestId("RecommendationRequestForm-requesterEmail").fill("adilahmed@ucsb.edu");
        ...
        page.getByTestId("RecommendationRequestForm-dateRequested").fill("2022-01-03T00:00:00");
    ...
    public void regular_user_cannot_create_recommendation_request() throws Exception {
        ...
        assertThat(page.getByTestId("RecommendationRequestTable-cell-row-0-col-")).not().isVisible();
    }
}