                ...
                <Col>
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control
                            ...
                            {...register("url", { required: true, pattern: isUrl_regex })}
                        />
                        <Form.Control.Feedback type="invalid">
                            {errors.url && 'Url is required. '}
                            {errors.url?.type === 'pattern' && 'Url must be in the correct format, eg. https://fake.com'}
                        </Form.Control.Feedback>
                    </Form.Group>
                </Col>
                    ...
                    <Col>
                        ...
                        <Form.Group className="mb-3" >
                            ...
                            <Form.Control
                                ...
                                {...register("email", { required: true, pattern: isEmail_regex })}
                            />
                            <Form.Control.Feedback type="invalid">
                            {errors.email && 'Email is required. '}
                            {errors.email?.type === 'pattern' && 'Email must be in the correct format, eg fake@gmail.com'}
                            </Form.Control.Feedback>
                        </Form.Group>
                    </Col>
                </Row>
